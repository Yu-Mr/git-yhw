...
{			
	...
	GPIO_InitStructure.GPIO_Pin = Soft_IIC_SDA|Soft_IIC_SCL ;	
...
/**************************实现函数********************************************
*函数原型:		用于DMP的写
*功　　能:		i2c_write(unsigned char slave_addr, unsigned char reg_addr,unsigned char length, unsigned char const *data)
*******************************************************************************/
...
/**************************实现函数********************************************
*函数原型:		用于DMP的读
*功　　能:		i2c_read(unsigned char slave_addr, unsigned char reg_addr,unsigned char length, unsigned char *data)
*******************************************************************************/
